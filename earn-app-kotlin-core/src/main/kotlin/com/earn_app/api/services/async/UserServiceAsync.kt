...
interface UserServiceAsync {
    ...
    /** @see [retrieveByWallet] */
    suspend fun retrieveByWallet(address: String, requestOptions: RequestOptions): User =
    ...
    interface WithRawResponse {
        ...
        fun stakes(): StakeServiceAsync.WithRawResponse
         ...
         * as [UserServiceAsync.listMissions].
         */
        @MustBeClosed
        suspend fun listMissions(
            userId: Long,
         ...
         * same as [UserServiceAsync.listReferrals].
         */
        @MustBeClosed
        suspend fun listReferrals(
            userId: Long,
         ...
         * as [UserServiceAsync.retrieveByWallet].
         */
        @MustBeClosed
        suspend fun retrieveByWallet(
            address: String,
