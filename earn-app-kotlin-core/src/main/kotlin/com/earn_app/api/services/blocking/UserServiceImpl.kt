...
import com.earn_app.api.services.blocking.users.StakeServiceImpl
...
class UserServiceImpl internal constructor(private val clientOptions: ClientOptions) : UserService {
    ...
    private val stakes: StakeService by lazy { StakeServiceImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val stakes: StakeService.WithRawResponse by lazy {
            StakeServiceImpl.WithRawResponseImpl(clientOptions)
        }
        ...
        override fun stakes(): StakeService.WithRawResponse = stakes
