...
class StakeServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    StakeServiceAsync {

    private val withRawResponse: StakeServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): StakeServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): StakeServiceAsync =
        StakeServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            StakeServiceAsyncImpl.WithRawResponseImpl(
