...
/**
 * A client for interacting with the Earn App REST API asynchronously. You can also switch to
...
interface EarnAppClientAsync {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): EarnAppClientAsync

    fun users(): UserServiceAsync

    fun missions(): MissionServiceAsync

    fun staking(): StakingServiceAsync
    ...
    /**
     * A view of [EarnAppClientAsync] that provides access to raw HTTP responses for each method.
     */
    interface WithRawResponse {
        ...
        fun staking(): StakingServiceAsync.WithRawResponse
