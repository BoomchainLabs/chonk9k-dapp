...
/**
 * A client for interacting with the Earn App REST API synchronously. You can also switch to
...
interface EarnAppClient {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): EarnAppClient

    fun users(): UserService

    fun missions(): MissionService

    fun staking(): StakingService
    ...
    /** A view of [EarnAppClient] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: (ClientOptions.Builder) -> Unit): EarnAppClient.WithRawResponse

        fun users(): UserService.WithRawResponse

        fun missions(): MissionService.WithRawResponse

        fun staking(): StakingService.WithRawResponse
