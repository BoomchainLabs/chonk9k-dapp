...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun referralCode(): String? = body.referralCode()
     ...
     */
    fun _referralCode(): JsonField<String> = body._referralCode()
    ...
    class Builder internal constructor() {
        ...
        /** Referral code used during signup */
        fun referralCode(referralCode: String) = apply { body.referralCode(referralCode) }
    ...
    private constructor(
        ...
        ) : this(walletAddress, email, referralCode, username, mutableMapOf())
         ...
         * Returns the raw JSON value of [referralCode].
         *
         * Unlike [referralCode], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("referralCode")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             * Sets [Builder.referralCode] to an arbitrary JSON value.
             *
             * You should usually call [Builder.referralCode] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun referralCode(referralCode: JsonField<String>) = apply {
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && walletAddress == other.walletAddress && email == other.email && referralCode == other.referralCode && username == other.username && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(walletAddress, email, referralCode, username, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{walletAddress=$walletAddress, email=$email, referralCode=$referralCode, username=$username, additionalProperties=$additionalProperties}"
    }
