...
import com.earn_app.api.core.http.HttpRequestBody
import com.earn_app.api.core.http.HttpResponse
import com.earn_app.api.errors.EarnAppIoException
...
class OkHttpClient private constructor(private val okHttpClient: okhttp3.OkHttpClient) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw EarnAppIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("EARN_APP_LOG")?.lowercase()) {
